...
class TransformerRollingDiffusionPolicy(BaseImagePolicy):
    def __init__(
        self,
        shape_meta: dict,
        # task params
    ...
    def predict_action(
        ...
        if self.window is None:
            action_pred = self.diffusion.sample_init(cond)
        else:
            action_pred = self.diffusion.sample(self.window, cond)
    ...
    def compute_loss(self, batch):
        ...
        loss = self.diffusion(trajectory, cond)
        return loss
